...
echo "=== LN06 (codigo_recurso={$codigoRecurso}, linha_id={$linhaId}) ===\n";
...
foreach ($ocorrencias as $row) {
    ...
    if (! isset($skusSet[$origem]) || ! isset($skusSet[$destino])) {
        // Par envolve SKU que não pertence à lista oficial de produtos da LN06
...
$overrides = [
    ['20070002', '20090002', 10],
    ['20090002', '20060012', 10],
    ['20110007', '20110023', 10],
    ['20110030', '20110027', 10],
    ['20060036', '20060012', 10],
    ['20060027', '20060016', 10],
    ['20110004', '20070008', 10],
];
...
echo "{$paresForaDaLinha} ocorrência(s) ignorada(s) por envolver SKU fora da lista oficial da LN06.\n\n";
...
echo "Pares ignorados por envolver SKU fora da lista oficial da LN06: {$paresForaDaLinha}\n";
