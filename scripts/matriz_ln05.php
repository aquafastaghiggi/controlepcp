...
echo "=== LN05 (codigo_recurso={$codigoRecurso}, linha_id={$linhaId}) ===\n";
...
foreach ($ocorrencias as $row) {
    ...
    if (! isset($skusSet[$origem]) || ! isset($skusSet[$destino])) {
        // Par envolve SKU que não pertence à lista oficial de produtos da LN05
...
// Correções manuais: pares com valor zerado ou abaixo de 5 min viram o
// mínimo de 10 min (revisão manual pós dry-run).
$overrides = [
    ['20040074', '20200026', 10],
    ['20040095', '20040091', 10],
    ['20200009', '20040075', 10],
    ['20200009', '20030010', 10],
    ['20030024', '20030009', 10],
    ['20040074', '20040095', 10],
    ['20040086', '20040107', 10],
    ['20200026', '20200020', 10],
    ['20200027', '20200009', 10],
    ['20200020', '20200022', 10],
];
...
echo "{$paresForaDaLinha} ocorrência(s) ignorada(s) por envolver SKU fora da lista oficial da LN05.\n\n";
...
echo "Pares ignorados por envolver SKU fora da lista oficial da LN05: {$paresForaDaLinha}\n";
