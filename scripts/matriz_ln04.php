...
echo "=== LN04 (codigo_recurso={$codigoRecurso}, linha_id={$linhaId}) ===\n";
...
foreach ($ocorrencias as $row) {
    ...
    if (! isset($skusSet[$origem]) || ! isset($skusSet[$destino])) {
        // Par envolve SKU que não pertence à lista oficial de produtos da LN04
...
$overrides = [
    ['20030002', '20030003', 10],
    ['20030011', '20030004', 10],
    ['20030012', '20030011', 10],
    ['20030012', '20030013', 10],
    ['20030012', '20030014', 10],
    ['20050151', '20050156', 10],
    ['20050150', '20050155', 10],
    ['20050155', '20050157', 10],
    ['20050149', '20050151', 10],
];
...
echo "{$paresForaDaLinha} ocorrência(s) ignorada(s) por envolver SKU fora da lista oficial da LN04.\n\n";
...
echo "Pares ignorados por envolver SKU fora da lista oficial da LN04: {$paresForaDaLinha}\n";
