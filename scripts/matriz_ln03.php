...
echo "=== LN03 (codigo_recurso={$codigoRecurso}, linha_id={$linhaId}) ===\n";
...
foreach ($ocorrencias as $row) {
    ...
    if (! isset($skusSet[$origem]) || ! isset($skusSet[$destino])) {
        // Par envolve SKU que não pertence à lista oficial de produtos da LN03
...
echo "{$paresForaDaLinha} ocorrência(s) ignorada(s) por envolver SKU fora da lista oficial da LN03.\n\n";
...
echo "Pares ignorados por envolver SKU fora da lista oficial da LN03: {$paresForaDaLinha}\n";
