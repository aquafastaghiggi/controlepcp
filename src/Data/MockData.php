    ...
    public static function all(): array
    {
        return [
            'calendar' => [
                ...
                'holidays' => [],
                'intervals' => [
                    ['start' => '07:10', 'end' => '11:28', 'days' => [1, 2, 3, 4, 5]],
                    ['start' => '13:35', 'end' => '17:40', 'days' => [1, 2, 3, 4, 5]],
                    ['start' => '17:40', 'end' => '22:00', 'days' => [1, 2, 3, 4, 5]],
                    ['start' => '23:00', 'end' => '03:00', 'days' => [1, 2, 3, 4, 5]],
                ],
            ],
            'products' => [
                'AGUA SANITARIA 5L' => [
                    'description' => 'Agua Sanitaria 5L',
                    'reference_setup' => 'AGUA SANITARIA 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
                'ALVEJANTE S/ CLORO 3L' => [
                    ...
                    'reference_setup' => 'ALVEJANTE S/ CLORO 3L',
                    'line' => 'L2',
                    'rate_per_hour' => 180.0,
                    'unit' => 'cx',
                ],
                'DESINFETANTE CAMPOS LAVANDA 5L' => [
                    ...
                    'reference_setup' => 'DESINFETANTE CAMPOS LAVANDA 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
                'DESINFETANTE ENERGIA 5L' => [
                    ...
                    'reference_setup' => 'DESINFETANTE ENERGIA 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
                'DESINFETANTE FL. DE EUCALIPTO 5L' => [
                    ...
                    'reference_setup' => 'DESINFETANTE FL. DE EUCALIPTO 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
                'DESINFETANTE HARMONIA NATURAL 5L' => [
                    ...
                    'reference_setup' => 'DESINFETANTE HARMONIA NATURAL 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
                'DESINFETANTE JARDIM FLORIDO 5L' => [
                    ...
                    'reference_setup' => 'DESINFETANTE JARDIM FLORIDO 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
                'DESINFETANTE MARINE 5L' => [
                    ...
                    'reference_setup' => 'DESINFETANTE MARINE 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
                'DESINFETANTE PAIXAO 5L' => [
                    ...
                    'reference_setup' => 'DESINFETANTE PAIXAO 5L',
                    'line' => 'L2',
                    'rate_per_hour' => 200.0,
                    'unit' => 'cx',
                ],
